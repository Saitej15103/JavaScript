let data = [
  ...
  items.style.backgroundColor="lightgreen"
            ...
            alldata.textContent=""
                for(let i=0;i<data.length;i++){
                    if(data[i].category=="audio"){
                        ...
                        audiocard.innerHTML=`
                        <h3>${data[i].title}</h3>
                        <img src="${data[i].image}" width="250px" height="250px">
                        <h4> $ ${data[i].price}</h4>`
                        audiocard.style.border="1px solid black"
                        audiocard.style.borderRadius="10px"
                        audiocard.style.display="flex"
                        audiocard.style.flexDirection="column"
                        audiocard.style.alignItems="center"
                        audiocard.style.width="350px"
                        audiocard.style.padding="10px"
                        audiocard.style.fontFamily="Arial Narrow"
                        audiocard.style.backgroundColor="lightblue"
                        alldata.append(audiocard)
                        alldata.style.display="flex"
                        alldata.style.flexWrap="wrap"
                        alldata.style.rowGap="10px"
                        alldata.style.columnGap="10px"
                        alldata.style.justifyContent="center"
                    }
                }
        })

    let Gamming = document.getElementById("gamming")
        Gamming.addEventListener("click",()=>{
            alldata.innerHTML=""
            for(let i=0;i<data.length;i++){
                if(data[i].category=="gaming"){
                    let gammingcard = document.createElement("div")
                    gammingcard.innerHTML=`
                    <h3>${data[i].title}<h3/>
                    <img src="${data[i].image}" width="250px" height="250px">
                    <h4> $ ${data[i].price}<h4/>`
                    gammingcard.style.border="1px solid black"
                    gammingcard.style.borderRadius="10px"
                    gammingcard.style.display="flex"
                    gammingcard.style.flexDirection="column"
                    gammingcard.style.alignItems="center"
                    gammingcard.style.width="350px"
                    gammingcard.style.padding="10px"
                    gammingcard.style.fontFamily="Arial Narrow"
                    gammingcard.style.backgroundColor="lightblue"
                    alldata.style.display="flex"
                    alldata.style.flexWrap="wrap"
                    alldata.style.rowGap="10px"
                    alldata.style.columnGap="10px"
                    alldata.style.justifyContent="center"
                    alldata.append(gammingcard)
        ...
        mobile.addEventListener("click",()=>{
            ...
            for(let i=0;i<data.length;i++){
                if(data[i].category=="mobile"){
                    ...
                    <img src="${data[i].image}" width="250px" height="250px">
                    <h4> $ ${data[i].price}</h4>`
                    mobilecard.style.border="1px solid black"
                    mobilecard.style.borderRadius="10px"
                    mobilecard.style.display="flex"
                    mobilecard.style.flexDirection="column"
                    mobilecard.style.alignItems="center"
                    mobilecard.style.width="350px"
                    mobilecard.style.padding="10px"
                    mobilecard.style.fontFamily="Arial Narrow"
                    mobilecard.style.backgroundColor="lightblue"
                    alldata.style.display="flex"
                    alldata.style.flexWrap="wrap"
                    alldata.style.rowGap="10px"
                    alldata.style.columnGap="10px"
                    alldata.style.justifyContent="center"
                    alldata.append(mobilecard)
                }
            }
        })
    ...
    list.style.fontFamily="Arial Narrow"
